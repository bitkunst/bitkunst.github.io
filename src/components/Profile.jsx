    ...
    <FlexWrapper>
      ...
      <TextBox ref={profileRef}>
        ...
        <p className="introduceText">
          회사와 함께 성장하는 개발자가 되고자 합니다.
        </p>
        <Text>
          <HiOutlineMail className="icons" />
          <a href="mailto:bitkunst23@gmail.com">bitkunst23@gmail.com</a>
        </Text>
        <NonHoverText>
        ...
        <Text>
          ...
          <a
            href="https://github.com/bitkunst?tab=repositories"
            target="_blank"
            rel="noreferrer"
          >
            https://github.com/bitkunst
          </a>
        </Text>
        <Text>
          <SiTistory className="icons" />
          <a
            href="https://bitkunst.tistory.com"
            target="_blank"
            rel="noreferrer"
          >
            https://bitkunst.tistory.com
          </a>
        </Text>
      </TextBox>
    </FlexWrapper>
